...
it("should generate package metadata", function () {
    ...
    expect(code).toMatchInlineSnapshot(`
          ...
          // Metadata of all packages, keyed by package name
          export default {
              // Package 'test'
              "test": {
                  "name": "test",
                  "services": {
                      ...
                      "ServiceB": {
                          "name": "ServiceB",
                          "clazz": test_ServiceB,
                          "provides": [{ "name": "ServiceC", "qualifier": "C" }],
                          "references": {
                              "asd": { "name": "ServiceD", "qualifier": "D", "all": false }
                          }
                      }
                  },
                  "ui": {
                      "references": [
                          { "name": "foo.ServiceE", "qualifier": void 0, "all": false },
                          { "name": "foo.ServiceF", "qualifier": "F", "all": false }
                      ]
                  },
                  "properties": {
                      "some_property": { "value": "default_value", "required": true },
                      "complex_property": {
                          "value": {
                              "array": [1, 2, { "a": 3 }, [[[[[1]]]]]],
                              "bool": false,
